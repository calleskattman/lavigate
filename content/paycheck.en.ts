...
"US-FL": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of paycheck withholding, not a final tax calculation. Actual paychecks may vary due to employer payroll systems, rounding practices, and timing of earnings. State-specific income tax and withholding rules applicable in Florida may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-IL": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of payroll withholding, not a final tax calculation. Actual paychecks may vary due to employer payroll systems, rounding practices, and timing of earnings. State-specific income tax and withholding rules applicable in Illinois may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-TN": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of payroll withholding only. Actual paychecks may differ due to employer payroll calculations, rounding, pay frequency, and how federal withholding rules are applied. This estimate should not be treated as final annual tax liability.State-specific income tax and withholding rules applicable in Tennessee may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-VA": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of payroll withholding only. Actual paychecks may differ due to employer payroll calculations, rounding, pay frequency, and how official withholding tables or formulas are applied. This estimate should not be treated as final annual tax liability. State-specific income tax and withholding rules applicable in Virginia may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-NV": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of payroll withholding only. Actual paychecks may differ due to employer payroll calculations, rounding, pay frequency, and how federal withholding rules are applied. This estimate should not be treated as final annual tax liability.State-specific income tax and withholding rules applicable in Nevada may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-UT": {
  ...
  "sections": {
    "howItWorks": "Paycheck estimates for Utah are calculated using the selected pay frequency and gross earnings, with federal income tax withholding applied based on IRS Form W-4 information. Federal income tax withholding follows IRS rules based on Form W-4, and FICA covers Social Security and Medicare payroll taxes. Utah state income tax withholding is calculated using formula-based withholding methods published by the Utah State Tax Commission, which account for pay frequency, filing status, and withholding allowances rather than fixed tax brackets.",
...
"US-WA": {
  ...
  "sections": {
    ...
    "limitations": "This calculator provides an estimate of payroll withholding only. Actual paychecks may differ due to employer payroll calculations, rounding, pay frequency handling, and how federal withholding rules are applied. This estimate should not be treated as final annual tax liability. State-specific income tax and withholding rules applicable in Washington may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-MI": {
  ...
  "sections": {
    "howItWorks": "This paycheck estimate begins with gross pay for the selected pay period and applies federal withholding rules derived from IRS Publication 15-T and Form W-4. Federal income tax withholding follows IRS rules based on Form W-4. Michigan state income tax withholding is calculated using a flat percentage rate applied to compensation after subtracting the personal and dependency exemption allowance reported on Form MI-W4. FICA payroll taxes cover Social Security and Medicare.",
    ...
    "limitations": "This calculator provides an estimate of payroll withholding only. Actual paychecks may differ due to employer payroll systems, rounding, pay frequency handling, and how exemption allowances are applied. This estimate does not represent final annual tax liability. State-specific income tax and withholding rules applicable in Michigan may affect final take-home pay and are not fully captured by this estimate."
  },
  "faq": [
    {
...
"US-IN": {
  ...
  "sections": {
    "howItWorks": "For Indiana wages, paycheck estimates start from gross earnings and incorporate required federal payroll withholding rules tied to the employee’s Form W-4. Federal income tax withholding follows IRS rules based on Form W-4, along with FICA payroll taxes for Social Security and Medicare. Indiana state income tax is estimated using the statewide flat tax rate applied to taxable wages to provide a practical approximation of state withholding.",
...
"US-AL": {
  ...
  "sections": {
    "howItWorks": "Paycheck withholding estimates for Alabama begin with gross earnings for the pay period and apply federal income tax withholding using IRS Form W-4 information. Federal income tax withholding follows IRS Form W-4 rules. Alabama state income tax withholding is estimated using a simplified version of the official Alabama withholding formula, which annualizes wages, applies deductions and exemptions, calculates tax using progressive rates, and then converts the result back to the pay-period amount. FICA payroll taxes include Social Security and Medicare.",
...
"US-WI": {
  ...
  "sections": {
    "howItWorks": "For Wisconsin paychecks, the calculation starts with gross pay and applies federal withholding rules in accordance with IRS Publication 15-T. Federal income tax withholding is calculated using IRS rules based on Form W-4. Wisconsin state income tax withholding is estimated using an effective percentage of wages rather than the official Wisconsin Department of Revenue withholding tables or exemption-based calculations. FICA payroll taxes include Social Security and Medicare.",
...
"US-OH": {
  ...
  "sections": {
    "howItWorks": "For Ohio wages, this paycheck estimate is built from gross pay for the selected pay period before applying required federal withholding rules. Federal income tax withholding is calculated using IRS Publication 15-T methods tied to Form W-4 (2020+), and FICA includes Social Security and Medicare payroll taxes. Ohio employers determine state withholding using official period-specific withholding tables and percentage methods published by the Ohio Department of Taxation. Because those tables and methods are not implemented here, this tool focuses on federal withholding and FICA while presenting Ohio state withholding as an estimate.",
...
"US-AK": {
  ...
  "sections": {
    "howItWorks": "For Alaska wages, paycheck estimates are calculated using gross earnings for the selected pay frequency together with required federal withholding rules. Federal income tax withholding follows IRS Publication 15-T and Form W-4 (2020+). FICA payroll taxes include Social Security and Medicare. Because Alaska has no state income tax, there is no state payroll withholding applied.",
...
"US-NM": {
  ...
  "sections": {
    "howItWorks": "This paycheck estimate for New Mexico begins with gross pay and pay frequency before federal income tax withholding is applied. Federal income tax withholding is calculated using IRS Publication 15-T with Form W-4 (2020+) inputs, and FICA payroll taxes include Social Security and Medicare. New Mexico requires employers to withhold state income tax using official percentage-method tables that depend on pay frequency and the allowances claimed on the federal Form W-4.",
...
"US-WY": {
  ...
  "sections": {
    "howItWorks": "Wyoming paycheck estimates start from gross earnings for the selected pay period and then apply federal payroll withholding to determine net pay. Federal income tax withholding follows IRS Publication 15-T and Form W-4 (2020+). FICA payroll taxes include Social Security and Medicare. Because Wyoming has no state personal income tax, there is no state income tax withholding applied to wages.",
    ...
    "limitations": "Results are estimates of paycheck withholding and are not final tax liability or an exact match to an employer payroll system. This calculator does not include any local or municipal wage or income taxes. Wyoming does not levy state income tax, and employer-specific payroll calculations and pay frequency can cause actual paychecks to differ from this estimate."
  },
  "faq": [
...
"US-SD": {
  ...
  "sections": {
    "howItWorks": "For South Dakota paychecks, the estimate is based on gross pay for the selected pay frequency prior to applying federal withholding methods. Federal income tax withholding is calculated using IRS Publication 15-T with Form W-4 (2020+) inputs. FICA payroll taxes include Social Security and Medicare. Because South Dakota has no state personal income tax, there is no state income tax withholding applied to wages.",
    ...
    "limitations": "Results are estimates of paycheck withholding and are not final tax liability or an exact match to an employer payroll system. This calculator does not include any local or municipal wage or income taxes. South Dakota has no state income tax, and variations in employer payroll rules and pay frequency may affect final take-home pay beyond this estimate."
  },
  "faq": [
...
"US-VT": {
  ...
  "sections": {
    "howItWorks": "For Vermont wages, paycheck estimates begin with gross earnings and apply federal payroll withholding rules informed by IRS Form W-4 data. Federal income tax withholding follows IRS Publication 15-T rules using Form W-4 (2020+) inputs, and FICA includes Social Security and Medicare payroll taxes. Vermont law requires state income tax withholding from payments that are also subject to federal income tax withholding, with amounts determined using withholding tables, schedules, or formulae prescribed by the Vermont Commissioner of Taxes.",
...
"US-WV": {
  ...
  "sections": {
    "howItWorks": "Paycheck estimates for West Virginia begin with gross pay for the pay period and then apply applicable federal payroll withholding methods. Federal income tax withholding follows IRS Publication 15-T using Form W-4 (2020+) inputs, and FICA includes Social Security and Medicare payroll taxes. West Virginia state withholding is normally computed using official employer withholding tables or percentage methods that depend on the employee’s exemption certificate and the payroll period, which are not reproduced here.",
...
"US-DC": {
  ...
  "sections": {
    "howItWorks": "For District of Columbia paychecks, the estimate starts from gross earnings and incorporates federal withholding rules to calculate take-home pay. Federal income tax withholding follows IRS Publication 15-T using Form W-4 (2020+) inputs, and FICA includes Social Security and Medicare payroll taxes. DC income tax withholding is normally computed using DC’s wage-bracket tables or the percentage-of-wages method prescribed by the Office of Tax and Revenue (FR-230), which are not reproduced here.",
...
"US-RI": {
  ...
  "sections": {
    "howItWorks": "This estimate for Rhode Island paychecks is calculated from gross pay for the selected pay period before federal withholding is applied. Federal income tax withholding follows IRS Publication 15-T using Form W-4 (2020+) inputs, and FICA includes Social Security and Medicare payroll taxes. Rhode Island state withholding is normally computed using the Division of Taxation’s official withholding tables or percentage method tied to the employee’s RI-W4 and the payroll period, which are not reproduced here.",
